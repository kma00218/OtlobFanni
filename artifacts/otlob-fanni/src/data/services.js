...
export const categories = [
  ...
  { id: 'pipe_fittings',      sectionId: 'home_services',  nameAr: 'تركيب إناث',       nameEn: 'Pipe Fittings',            iconName: 'pipe_fittings',    sortOrder: 76 },
  { id: 'furniture_install',  sectionId: 'home_services',  nameAr: 'تركيب أثاث',       nameEn: 'Furniture Installation',   iconName: 'furniture_install', sortOrder: 77 },
  ...
  { id: 'excavator',         sectionId: 'construction', nameAr: 'سائق حفار',           nameEn: 'Excavator Operator',  iconName: 'heavy_truck_driver', sortOrder: 71 },
  ...
  { id: 'heavy_transport',        sectionId: 'moving_general', nameAr: 'نقل ثقيل',              nameEn: 'Heavy Transport',                   iconName: 'tire_repair',     sortOrder: 68 },
  { id: 'tipper_truck',           sectionId: 'moving_general', nameAr: 'قلاب ودنبر',            nameEn: 'Tipper Truck',                      iconName: 'tank_cleaning',   sortOrder: 69 },
  { id: 'construction_transport', sectionId: 'moving_general', nameAr: 'نقل مواد بناء',         nameEn: 'Construction Materials Transport',   iconName: 'contracting',     sortOrder: 70 },
