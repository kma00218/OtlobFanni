...
import { Info, FileText, Shield, Globe, Megaphone, HelpCircle, Share2, Heart, Download, Facebook, Instagram, ExternalLink, Bell, Briefcase, UserPlus, ClipboardList } from 'lucide-react';
    ...
    <div className="bg-[#F2F2F7] min-h-screen pt-20 pb-28" dir={ar ? 'rtl' : 'ltr'}>
        ...
        >
          <div className={`flex items-center gap-3 ${ar ? 'flex-row-reverse' : ''}`}>
            ...
            <div className={ar ? 'text-right' : 'text-left'}>
              <p className="text-white font-extrabold text-sm leading-tight">{ar ? 'تواصل معنا عبر واتساب' : 'Contact us on WhatsApp'}</p>
              <p className="text-white/80 text-xs mt-0.5 font-medium" dir="ltr">+49 179 1607597</p>
            </div>
          </div>
      ...
      <div className="px-4 mb-4">
        <a
          ...
          style={{ background: 'linear-gradient(90deg, #128C7E 0%, #075E54 100%)', boxShadow: '0 4px 16px rgba(18,140,126,0.3)' }}
        >
          ...
          <div className="flex-1 text-right">
            <p className="text-white font-extrabold text-sm leading-tight">
              {ar ? 'قناة واتساب الرسمية' : 'Official WhatsApp Channel'}
            </p>
            <p className="text-white/70 text-xs font-medium mt-0.5">{ar ? 'تحديثات وأخبار المنصة' : 'Platform updates & news'}</p>
          </div>
