  ...
  return (
    <div className="bg-background min-h-screen pt-16 pb-36">
      ...
      <main className="px-4 pt-2 pb-4 flex flex-col gap-4">
        <div className="flex items-center justify-between gap-2" onClick={handleLogoClick} style={{ cursor: 'default' }}>
          {/* WhatsApp Channel — right side (RTL) */}
          <a
            href="https://whatsapp.com/channel/0029Vb8BOc3KbYMKjnChAv0O"
            target="_blank"
            rel="noopener noreferrer"
            onClick={e => e.stopPropagation()}
            className="flex flex-col items-center gap-0.5 px-2 py-1.5 rounded-xl active:scale-95 transition-transform flex-shrink-0"
            style={{ background: 'linear-gradient(135deg, #128C7E 0%, #075E54 100%)', boxShadow: '0 3px 10px rgba(18,140,126,0.35)' }}
          >
            ...
            <span className="text-white font-black text-[9px] leading-tight text-center whitespace-nowrap">{ar ? 'قناة واتساب' : 'WA Channel'}</span>
            <span className="text-white/70 text-[8px] leading-none text-center whitespace-nowrap">{ar ? 'للتحديثات' : 'Updates'}</span>
          </a>
          ...
          {/* Telegram Channel — left side (RTL) */}
          <a
            ...
            onClick={e => e.stopPropagation()}
            className="flex flex-col items-center gap-0.5 px-2 py-1.5 rounded-xl active:scale-95 transition-transform flex-shrink-0"
            style={{ background: 'linear-gradient(135deg, #229ED9 0%, #1a7fb5 100%)', boxShadow: '0 3px 10px rgba(34,158,217,0.35)' }}
          >
            ...
            <span className="text-white font-black text-[9px] leading-tight text-center whitespace-nowrap">{ar ? 'قناة تيليغرام' : 'TG Channel'}</span>
            <span className="text-white/70 text-[8px] leading-none text-center whitespace-nowrap">{ar ? 'للتحديثات' : 'Updates'}</span>
          </a>
        </div>
