        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
          ...
          <div className="px-4 pb-4">
            ...
            <button
              ...
              className="w-full mt-1 flex items-center justify-center gap-1.5 bg-[#EEF2F7] hover:bg-[#DDE4EE] border border-[#071B33]/35 text-[#071B33] text-xs font-semibold py-2 rounded-xl active:scale-[0.98] transition-all">
