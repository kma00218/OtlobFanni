    ...
    <div className="bg-[#EEF4FF] min-h-screen pt-20 pb-28" dir={dir}>
      ...
      <main className="px-4 pt-4 space-y-4">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-1.5 bg-[#EEF2F7] hover:bg-[#DDE4EE] border border-slate-200 text-[#071B33]/65 hover:text-[#071B33]/80 text-xs font-semibold py-2 rounded-xl active:scale-[0.98] transition-all mt-1">
