          ...
          <div className="px-4 pb-5">
            ...
            <div className="mt-5 pt-4" style={{ borderTop: '1px dashed #D8E0EA' }}>
              <button
                ...
                className="w-full flex items-center justify-center gap-1.5 text-red-400 text-xs font-medium py-2 rounded-xl transition-all hover:text-red-500"
                style={{ background: 'transparent', border: '1px dashed #FCA5A5' }}>
