        ...
        <div className="bg-[#E4F7F6] rounded-2xl border border-teal-300 shadow-sm overflow-hidden">
          ...
          <div className="px-4 pt-0 pb-4 -mt-5">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-1.5 bg-[#EEF2F7] hover:bg-[#DDE4EE] border border-slate-200 text-[#071B33]/65 hover:text-[#071B33]/80 text-xs font-semibold py-2 rounded-xl active:scale-95 transition-all mt-1">
