      ...
      <div className="flex flex-col items-center gap-2 select-none cursor-pointer active:scale-90 transition-transform duration-150">
        <div className="relative">
          <img
            ...
            draggable="false"
            onError={(e) => {
              if (e.currentTarget.src.includes(iconKey) && iconKey !== category.id) {
                e.currentTarget.src = `/icons/categories/${category.id}.png`
              } else {
                e.currentTarget.src = '/icons/categories/more.png'
              }
            }}
          />
          {count > 0 && (
